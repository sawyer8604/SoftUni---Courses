...
namespace _6._Jagged_Array_Manipulator
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            IsEqualOrNot(rows, jaggedArray);

            string commands;

            commands = AddAndSubstract(jaggedArray);

            PrinTheResult(rows, jaggedArray);
        }

        
        static void IsEqualOrNot(int rows, int[][] jaggedArray)
        {
        ...
        static string AddAndSubstract(int[][] jaggedArray)
        {
            string commands;
        ...
        static void PrinTheResult(int rows, int[][] jaggedArray)
        {
