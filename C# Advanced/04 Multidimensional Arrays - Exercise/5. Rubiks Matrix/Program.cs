...
namespace RubiksMatrix
{
    public class StartUp
    {
        public static void Main()
        {
            ...
            int[,] bluePrint = new int[sizes[0], sizes[1]];
        ...
        static void EqualizeValue(int[,] matrix, int[,] bluePrint, ref int coordX, ref int coordY)
        {
            var swap = 0;
            for (int i = 0; i < matrix.GetLength(0); i++)
            {
        ...
        static void ShiftRow(int[,] matrix, string command, int index, int distance)
        {
            var last = 0;
            if (command == "left")
            {
        ...
        static void ShiftColumn(int[,] matrix, string command, int index, int distance)
        {
            var last = 0;
            if (command == "down")
            {
