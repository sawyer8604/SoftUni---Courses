...
namespace _03._P_rates_Class_Methods
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while ((commands = Console.ReadLine()) != "End")
            {
                ...
                if (firstCommand == "Plunder")
                {
                    ...
                    AttackedTheCity(cities, town, people, gold);
        ...
        static void AttackedTheCity(Dictionary<string, Cities> cities, string town, int people, int gold)
        {
            if (cities.ContainsKey(town))
            {
