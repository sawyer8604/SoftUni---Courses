...
namespace _03._Heroes_of_Code_and_Logic_VII_Class_Methods
{
    internal class Program
    {
            ...
            while ((commands = Console.ReadLine()) != "End")
            {
                ...
                switch (firstCommand)
                {
                    ...
                    case "CastSpell":
                        ...
                        SaySpelOrNot(heroes, heroName, neededManaPoint, spellName);
                    ...
                    case "TakeDamage":
                        ...
                        TakeDamage(heroes, damageHeroName, damage, attacker);
                    ...
                    case "Recharge":
                        ...
                        Recharge(heroes, heroRechargeName, amount);
                    ...
                    case "Heal":
                        ...
                        Heal(heroes, heroHealName, healthAmount);
        ...
        static void SaySpelOrNot(Dictionary<string, Heroes> heroes, string heroName, int neededManaPoint, string spellName)
        {
            if (heroes.ContainsKey(heroName))
            {
        ...
        static void TakeDamage(Dictionary<string, Heroes> heroes, string damageHeroName, int damage, string attacker)
        {
        ...
        static void Recharge(Dictionary<string, Heroes> heroes, string heroRechargeName, int amount)
        {
        ...
        static void Heal(Dictionary<string, Heroes> heroes, string heroHealName, int healthAmount)
        {
