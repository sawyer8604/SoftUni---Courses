    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while ((input = Console.ReadLine()) != "find")
            {
                ...
                newMessage = DecriptTheMessage(number, inputAsChar, ref numberCounter);

                FindMachesAndPrint(newMessage, typePattenr, coordinatePattern);

            }
        }

        static void FindMachesAndPrint(string newMessage, string typePattenr, string coordinatePattern)
        {
        ...
        static string DecriptTheMessage(int[] number, char[] inputAsChar, ref int numberCounter)
        {
            string newMessage;
