namespace DatabaseExtended.Tests
{
    ...
    {
        [TestCaseSource ("TestCaseDtaBaseConstructor")]

        public void Constructor_Shuld_Create_Data_With_ValidInput(Person[] people, int expectedCount)
        {
        ...
        public static IEnumerable<TestCaseData> TestCaseDtaBaseConstructor()
        {
