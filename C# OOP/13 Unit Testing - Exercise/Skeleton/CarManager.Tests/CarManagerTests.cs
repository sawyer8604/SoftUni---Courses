namespace CarManager.Tests
{
    ...
    public class CarManagerTests
    {
        ...
        public void SetUp()
        {
            this.car = new Car("VW", "Polo", 7.5, 50.0);
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new Car(make, "Polo", 7.5, 50.0));
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new Car("VW", model, 7.5, 50.0));
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new Car("VW", "Polo", fuelConsumption, 50.0));
        }
        ...
        {
            Assert.Throws<ArgumentException>(() => new Car("VW", "Polo", 7.5, fuelCapacity));
        }
