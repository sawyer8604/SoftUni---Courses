namespace INStock.Tests
{
    ...
    public class ProductStockTests
    {
        ...
        [Test]
        public void FindMostExpensiveProductSuccessfully()
        {
            Product product1 = new Product("Product1", 44, 7);
            ...
            var actualCollectionCount = productStock.FindMostExpensiveProduct();

            Assert.AreEqual(product2.Price, actualCollectionCount.Price);
        }
